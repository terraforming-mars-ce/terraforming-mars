...
func TestFilterChoiceIndicesByPolicy_AutoPlantTags3(t *testing.T) {
	choices := []shared.Choice{
		{Outputs: []shared.BehaviorCondition{shared.NewProductionCondition(shared.ResourcePlantProduction, 1, "")}},
		{Outputs: []shared.BehaviorCondition{shared.NewProductionCondition(shared.ResourcePlantProduction, 4, "")}},
	}
