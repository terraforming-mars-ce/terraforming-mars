...
func TestGenerationalEventRequirement_TRRaiseUnavailableWhenNotRaised(t *testing.T) {
	...
	behavior := shared.CardBehavior{
		...
		Inputs:   []shared.BehaviorCondition{&shared.BasicResourceCondition{ConditionBase: shared.ConditionBase{ResourceType: shared.ResourceCredit, Amount: 3}}},
		Outputs:  []shared.BehaviorCondition{&shared.GlobalParameterCondition{ConditionBase: shared.ConditionBase{ResourceType: shared.ResourceTR, Amount: 1}}},
...
func TestGenerationalEventRequirement_OceanPlacementMinTwoUnavailableWithOne(t *testing.T) {
	...
	behavior := shared.CardBehavior{
		Triggers: []shared.Trigger{{Type: shared.TriggerTypeManual}},
		Inputs:   []shared.BehaviorCondition{&shared.BasicResourceCondition{ConditionBase: shared.ConditionBase{ResourceType: shared.ResourceCredit, Amount: 5}}},
		Outputs:  []shared.BehaviorCondition{&shared.GlobalParameterCondition{ConditionBase: shared.ConditionBase{ResourceType: shared.ResourceTR, Amount: 1}}},
		GenerationalEventRequirements: []shared.GenerationalEventRequirement{
			{
